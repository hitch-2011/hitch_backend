...
RSpec.describe "Users API Endpoints" do
  describe "User Details" do
    ...
    it 'does not grab other rides' do
      ...
      user2 = User.create!(fullname: "fullname", email: "jake@gmail.com", password: "password", about_me: "I like driving.")
      user3 = User.create!(fullname: "fullname", email: "cydnee@gmail.com", password: "password", about_me: "I like driving.")
      user4= User.create!(fullname: "fullname", email: "differnt@gmail.com", password: "password", about_me: "I like driving.")
      friend = Friend.create!(user_id: user1.id, friend_id: user2.id)
      friend = Friend.create!(user_id: user1.id, friend_id: user3.id)
      trip = Ride.create!(origin: "origin", destination: "destination", departure_time: "9:00am", user_id: user1.id )
      trip2 = Ride.create!(origin: "origin", destination: "destination", departure_time: "9:00am", user_id: user3.id )
    ...
    it 'does not grab other rides' do
      ...
      user3 = User.create!(fullname: "fullname", email: "cydnee@gmail.com", password: "password", about_me: "I like driving.")
      user4= User.create!(fullname: "fullname", email: "differnt@gmail.com", password: "password", about_me: "I like driving.")
      user5 = User.create!(fullname: "fullname", email: "new@gmail.com", password: "password", about_me: "I like driving.")
      friend = Friend.create!(user_id: user1.id, friend_id: user2.id)
      friend = Friend.create!(user_id: user1.id, friend_id: user3.id)
