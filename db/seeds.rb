...
rideday = Rideday.create!(day_of_week: 'Monday', ride_id: ride4.id)
rideday = Rideday.create!(day_of_week: 'Monday', ride_id: ride5.id)
rideday2 = Rideday.create!(day_of_week: 'Wednesday', ride_id: ride1.id)
rideday2 = Rideday.create!(day_of_week: 'Wednesday', ride_id: ride2.id)
rideday2 = Rideday.create!(day_of_week: 'Wednesday', ride_id: ride3.id)
rideday2 = Rideday.create!(day_of_week: 'Wednesday', ride_id: ride4.id)
rideday8 = Rideday.create!(day_of_week: 'Wednesday', ride_id: ride5.id)
...
rideday3 = Rideday.create!(day_of_week: 'Thursday', ride_id: ride4.id)
